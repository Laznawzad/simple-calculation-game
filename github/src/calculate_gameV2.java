...
public class calculate_gameV2 {
        ...
        while (choice != 5 ){
            ...
            switch (choice){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    insaneDifficulty(Number1, Number2);
                    break;
                case 5:
    ...
    public static void insaneDifficulty(int number1, int number2){
        life = 10;
        int result = 0;
        int userAnswer;

        while (life > 0){
            number1 = ran.nextInt(1,5001);
            number2 = ran.nextInt(1,5001);
            char[] operators = {'+', '-', '*'};
            char op = operators[ran.nextInt(operators.length)];
            result = switch (op) {
                case '+' -> number1 + number2;
